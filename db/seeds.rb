...
follow3 = Follow.create!(follower_id: test_user.id, followed_id: user3.id)
follow4 = Follow.create!(follower_id: test_user.id, followed_id: user4.id)
follow5 = Follow.create!(follower_id: test_user.id, followed_id: user5.id)
follow6 = Follow.create!(follower_id: test_user.id, followed_id: drake.id)
follow7 = Follow.create!(follower_id: user2.id, followed_id: test_user.id)
follow8 = Follow.create!(follower_id: user2.id, followed_id: user3.id)
follow9 = Follow.create!(follower_id: user3.id, followed_id: user4.id)
follow10 = Follow.create!(follower_id: user3.id, followed_id: drake.id)
follow11 = Follow.create!(follower_id: test_user.id, followed_id: user4.id)
follow12 = Follow.create!(follower_id: test_user.id, followed_id: user5.id)
